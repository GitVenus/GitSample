...
public class AllyTestOne {
  ...
  public void sampleOneTest() {
	  ...
	  if(violations.size()==0) {
		  Assert.assertTrue(true,"No violations foubd");
	  }
	  else {
		  ...
		  Assert.assertEquals(violations.size(), 7, violations.size() + "violations are found.");
